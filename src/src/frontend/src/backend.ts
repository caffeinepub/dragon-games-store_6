...
export class Backend implements backendInterface {
    ...
    async createGame(arg0: string, arg1: ExternalBlob, arg2: bigint, arg3: string, arg4: Array<Platform>, arg5: boolean): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createGame(arg0, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg1), arg2, arg3, to_candid_vec_n11(this._uploadFile, this._downloadFile, arg4), arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGameById(arg0: string): Promise<Game> {
        if (this.processError) {
            try {
                const result = await this.actor.getGameById(arg0);
                return from_candid_Game_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateGame(arg0: string, arg1: string, arg2: ExternalBlob, arg3: bigint, arg4: string, arg5: Array<Platform>, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateGame(arg0, arg1, await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg2), arg3, arg4, to_candid_vec_n11(this._uploadFile, this._downloadFile, arg5), arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Game_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Game): Promise<Game> {
    return await from_candid_record_n16(_uploadFile, _downloadFile, value);
}
function from_candid_Platform_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Platform): Platform {
...
async function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        name: value.name,
        posterBlob: await from_candid_ExternalBlob_n17(_uploadFile, _downloadFile, value.posterBlob),
        trailerUrl: value.trailerUrl,
        platforms: from_candid_vec_n18(_uploadFile, _downloadFile, value.platforms),
        price: value.price,
        onSale: value.onSale
    };
}
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pc" in value ? Platform.pc : "xbox" in value ? Platform.xbox : "playstation" in value ? Platform.playstation : value;
}
...
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Game>): Promise<Array<Game>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Game_n15(_uploadFile, _downloadFile, x)));
}
function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Platform>): Array<Platform> {
    return value.map((x)=>from_candid_Platform_n19(_uploadFile, _downloadFile, x));
}
...
function to_candid_Platform_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Platform): _Platform {
...
function to_candid_variant_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Platform): {
    pc: null;
} | {
    xbox: null;
} | {
...
function to_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<Platform>): Array<_Platform> {
    return value.map((x)=>to_candid_Platform_n12(_uploadFile, _downloadFile, x));
}
